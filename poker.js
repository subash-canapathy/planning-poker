PokerClient = function (id, user, host, connection) {
    var self = this;
    ...
    this.newGame = function () {
        ...
        self.sendMessage(self.host, "nameChanged", [document.getElementById("game-name").innerText]);
    };
    ...
    this.changeName = function (txt) {
        document.getElementById("game-name").innerText = txt;
    }
